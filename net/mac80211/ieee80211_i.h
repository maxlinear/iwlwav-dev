...
struct ieee802_11_elems *ieee802_11_parse_elems_crc(const u8 *start, size_t len, bool action,
			u8 *vendor_events_filter, u8 vendor_events_filter_len,
			u64 filter, u32 crc, u8 *transmitter_bssid,
			u8 *bss_bssid);
static inline struct ieee802_11_elems  *ieee802_11_parse_elems(const u8 *start, size_t len,
					  bool action,
					  u8 *transmitter_bssid,
					  u8 *bss_bssid)
{
	return ieee802_11_parse_elems_crc(start, len, action, NULL, 0, 0, 0,
