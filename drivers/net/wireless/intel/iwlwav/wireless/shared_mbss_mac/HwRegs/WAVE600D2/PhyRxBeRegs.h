...
typedef union
{
	...
	struct
	{
		uint32 ldpcLastSymbolCwIndex : 15; //ldpc_last_symbol_cw_index, reset value: 0x0, access type: RO
		uint32 reserved0 : 17;
	} bitFields;
...
typedef union
{
	...
	struct
	{
		uint32 descramblerSeed : 7; //descrambler_seed, reset value: 0x0, access type: RO
		uint32 reserved0 : 25;
	} bitFields;
