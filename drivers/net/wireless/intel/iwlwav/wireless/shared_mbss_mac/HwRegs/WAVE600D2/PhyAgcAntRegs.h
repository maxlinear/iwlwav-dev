...
************************************************************************************/
#ifndef _PHY_AGC_ANT_REGS_H_
#define _PHY_AGC_ANT_REGS_H_
...
#define PHY_AGC_ANT_BASE_ADDRESS                             MEMORY_MAP_UNIT_74_BASE_ADDRESS
#define	REG_PHY_AGC_ANT_BB_RSSI_PARAMS_REG                      (PHY_AGC_ANT_BASE_ADDRESS + 0x0)
#define	REG_PHY_AGC_ANT_BB_RSSI_OFFSET2_REG                     (PHY_AGC_ANT_BASE_ADDRESS + 0x4)
#define	REG_PHY_AGC_ANT_BB_RSSI_SYSTEM_GAIN_REG                 (PHY_AGC_ANT_BASE_ADDRESS + 0x8)
#define	REG_PHY_AGC_ANT_BB_RSSI_SYSTEM_GAIN_SELECT_REG          (PHY_AGC_ANT_BASE_ADDRESS + 0xC)
#define	REG_PHY_AGC_ANT_BB_RSSI_SAT_THR                         (PHY_AGC_ANT_BASE_ADDRESS + 0x10)
#define	REG_PHY_AGC_ANT_INB_RSSI_PARAMS_REG                     (PHY_AGC_ANT_BASE_ADDRESS + 0x14)
#define	REG_PHY_AGC_ANT_INB_RSSI_OFFSET2_REG                    (PHY_AGC_ANT_BASE_ADDRESS + 0x18)
#define	REG_PHY_AGC_ANT_INBAND_RSSI_SYSTEM_GAIN_REG             (PHY_AGC_ANT_BASE_ADDRESS + 0x1C)
#define	REG_PHY_AGC_ANT_INBAND_RSSI_SYSTEM_GAIN_SELECT_REG      (PHY_AGC_ANT_BASE_ADDRESS + 0x20)
#define	REG_PHY_AGC_ANT_INBAND_RSSI_SAT_THR                     (PHY_AGC_ANT_BASE_ADDRESS + 0x24)
#define	REG_PHY_AGC_ANT_FB_RSSI_PARAMS_REG                      (PHY_AGC_ANT_BASE_ADDRESS + 0x28)
#define	REG_PHY_AGC_ANT_FB_RSSI_OFFSET2_REG                     (PHY_AGC_ANT_BASE_ADDRESS + 0x2C)
#define	REG_PHY_AGC_ANT_FB_RSSI_SYSTEM_GAIN_REG                 (PHY_AGC_ANT_BASE_ADDRESS + 0x30)
#define	REG_PHY_AGC_ANT_FB_RSSI_SYSTEM_GAIN_SELECT_REG          (PHY_AGC_ANT_BASE_ADDRESS + 0x34)
#define	REG_PHY_AGC_ANT_FB_RSSI_SAT_THR                         (PHY_AGC_ANT_BASE_ADDRESS + 0x38)
#define	REG_PHY_AGC_ANT_HB_RSSI_PARAMS_REG                      (PHY_AGC_ANT_BASE_ADDRESS + 0x3C)
#define	REG_PHY_AGC_ANT_HB_RSSI_OFFSET2_REG                     (PHY_AGC_ANT_BASE_ADDRESS + 0x40)
#define	REG_PHY_AGC_ANT_HB_RSSI_SYSTEM_GAIN_REG                 (PHY_AGC_ANT_BASE_ADDRESS + 0x44)
#define	REG_PHY_AGC_ANT_HB_RSSI_SYSTEM_GAIN_SELECT_REG          (PHY_AGC_ANT_BASE_ADDRESS + 0x48)
#define	REG_PHY_AGC_ANT_HB_RSSI_SAT_THR                         (PHY_AGC_ANT_BASE_ADDRESS + 0x4C)
#define	REG_PHY_AGC_ANT_RF_RSSI_PARAMS_REG                      (PHY_AGC_ANT_BASE_ADDRESS + 0x50)
#define	REG_PHY_AGC_ANT_RF_RSSI_OFFSET1_RX_RANGE0               (PHY_AGC_ANT_BASE_ADDRESS + 0x54)
#define	REG_PHY_AGC_ANT_RF_RSSI_OFFSET1_RX_RANGE1               (PHY_AGC_ANT_BASE_ADDRESS + 0x58)
#define	REG_PHY_AGC_ANT_RF_RSSI_OFFSET1_TX                      (PHY_AGC_ANT_BASE_ADDRESS + 0x5C)
#define	REG_PHY_AGC_ANT_RF_RSSI_OFFSET2_RX_REG                  (PHY_AGC_ANT_BASE_ADDRESS + 0x60)
#define	REG_PHY_AGC_ANT_RF_RSSI_OFFSET2_TX_REG                  (PHY_AGC_ANT_BASE_ADDRESS + 0x64)
#define	REG_PHY_AGC_ANT_RF_RSSI_SYSTEM_GAIN_REG                 (PHY_AGC_ANT_BASE_ADDRESS + 0x68)
#define	REG_PHY_AGC_ANT_RF_RSSI_SYSTEM_GAIN_SELECT_REG          (PHY_AGC_ANT_BASE_ADDRESS + 0x6C)
#define	REG_PHY_AGC_ANT_RF_RSSI_SAT_THR_RANGE0                  (PHY_AGC_ANT_BASE_ADDRESS + 0x70)
#define	REG_PHY_AGC_ANT_RF_RSSI_SAT_THR_RANGE1                  (PHY_AGC_ANT_BASE_ADDRESS + 0x74)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_A_RANGE0_REG               (PHY_AGC_ANT_BASE_ADDRESS + 0x78)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_A_RANGE1_REG               (PHY_AGC_ANT_BASE_ADDRESS + 0x7C)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_A2_RANGE0_REG              (PHY_AGC_ANT_BASE_ADDRESS + 0x80)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_A2_RANGE1_REG              (PHY_AGC_ANT_BASE_ADDRESS + 0x84)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_B_RANGE0_REG               (PHY_AGC_ANT_BASE_ADDRESS + 0x88)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_B_RANGE1_REG               (PHY_AGC_ANT_BASE_ADDRESS + 0x8C)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_C_RANGE0_REG               (PHY_AGC_ANT_BASE_ADDRESS + 0x90)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_C_RANGE1_REG               (PHY_AGC_ANT_BASE_ADDRESS + 0x94)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_NLOG_RANGE0_REG            (PHY_AGC_ANT_BASE_ADDRESS + 0x98)
#define	REG_PHY_AGC_ANT_RF_RSSI_COEF_NLOG_RANGE1_REG            (PHY_AGC_ANT_BASE_ADDRESS + 0x9C)
#define	REG_PHY_AGC_ANT_RF_TSSI_COEF_A_REG                      (PHY_AGC_ANT_BASE_ADDRESS + 0xA0)
#define	REG_PHY_AGC_ANT_RF_TSSI_COEF_A2_REG                     (PHY_AGC_ANT_BASE_ADDRESS + 0xA4)
#define	REG_PHY_AGC_ANT_RF_TSSI_COEF_B_REG                      (PHY_AGC_ANT_BASE_ADDRESS + 0xA8)
#define	REG_PHY_AGC_ANT_RF_TSSI_COEF_C_REG                      (PHY_AGC_ANT_BASE_ADDRESS + 0xAC)
#define	REG_PHY_AGC_ANT_RF_TSSI_COEF_NLOG_REG                   (PHY_AGC_ANT_BASE_ADDRESS + 0xB0)
#define	REG_PHY_AGC_ANT_RF_RSSI_TX_RX_REG                       (PHY_AGC_ANT_BASE_ADDRESS + 0xB4)
#define	REG_PHY_AGC_ANT_BB_RSSI_REG                             (PHY_AGC_ANT_BASE_ADDRESS + 0xB8)
#define	REG_PHY_AGC_ANT_BB_POWER_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xBC)
#define	REG_PHY_AGC_ANT_BB_SRSSI_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xC0)
#define	REG_PHY_AGC_ANT_BB_SPOWER_REG                           (PHY_AGC_ANT_BASE_ADDRESS + 0xC4)
#define	REG_PHY_AGC_ANT_BB_PWR_DIFF_REG                         (PHY_AGC_ANT_BASE_ADDRESS + 0xC8)
#define	REG_PHY_AGC_ANT_IB_RSSI_REG                             (PHY_AGC_ANT_BASE_ADDRESS + 0xCC)
#define	REG_PHY_AGC_ANT_IB_POWER_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xD0)
#define	REG_PHY_AGC_ANT_IB_SRSSI_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xD4)
#define	REG_PHY_AGC_ANT_IB_SPOWER_REG                           (PHY_AGC_ANT_BASE_ADDRESS + 0xD8)
#define	REG_PHY_AGC_ANT_IB_PWR_DIFF_REG                         (PHY_AGC_ANT_BASE_ADDRESS + 0xDC)
#define	REG_PHY_AGC_ANT_FB_RSSI_REG                             (PHY_AGC_ANT_BASE_ADDRESS + 0xE0)
#define	REG_PHY_AGC_ANT_FB_POWER_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xE4)
#define	REG_PHY_AGC_ANT_FB_SRSSI_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xE8)
#define	REG_PHY_AGC_ANT_FB_SPOWER_REG                           (PHY_AGC_ANT_BASE_ADDRESS + 0xEC)
#define	REG_PHY_AGC_ANT_FB_PWR_DIFF_REG                         (PHY_AGC_ANT_BASE_ADDRESS + 0xF0)
#define	REG_PHY_AGC_ANT_HB_RSSI_REG                             (PHY_AGC_ANT_BASE_ADDRESS + 0xF4)
#define	REG_PHY_AGC_ANT_HB_POWER_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xF8)
#define	REG_PHY_AGC_ANT_HB_SRSSI_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0xFC)
#define	REG_PHY_AGC_ANT_HB_SPOWER_REG                           (PHY_AGC_ANT_BASE_ADDRESS + 0x100)
#define	REG_PHY_AGC_ANT_HB_PWR_DIFF_REG                         (PHY_AGC_ANT_BASE_ADDRESS + 0x104)
#define	REG_PHY_AGC_ANT_RF_RSSI_REG                             (PHY_AGC_ANT_BASE_ADDRESS + 0x108)
#define	REG_PHY_AGC_ANT_RF_POWER_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0x10C)
#define	REG_PHY_AGC_ANT_RF_SRSSI_REG                            (PHY_AGC_ANT_BASE_ADDRESS + 0x110)
#define	REG_PHY_AGC_ANT_RF_SPOWER_REG                           (PHY_AGC_ANT_BASE_ADDRESS + 0x114)
#define	REG_PHY_AGC_ANT_SATURATION_RESULT                       (PHY_AGC_ANT_BASE_ADDRESS + 0x118)
#define	REG_PHY_AGC_ANT_RSSI_BLOCKS_GCLK_EN                     (PHY_AGC_ANT_BASE_ADDRESS + 0x11C)
#define	REG_PHY_AGC_ANT_RF_RSSI_DEC_OUT_STS                     (PHY_AGC_ANT_BASE_ADDRESS + 0x120)
#define	REG_PHY_AGC_ANT_PM_RF_POWER                             (PHY_AGC_ANT_BASE_ADDRESS + 0x140)
#define	REG_PHY_AGC_ANT_PM_FB_POWER                             (PHY_AGC_ANT_BASE_ADDRESS + 0x144)
#define	REG_PHY_AGC_ANT_PM_BB_POWER                             (PHY_AGC_ANT_BASE_ADDRESS + 0x148)
#define	REG_PHY_AGC_ANT_PM_HB_POWER                             (PHY_AGC_ANT_BASE_ADDRESS + 0x14C)
#define	REG_PHY_AGC_ANT_PM_IB_POWER                             (PHY_AGC_ANT_BASE_ADDRESS + 0x150)
#define	REG_PHY_AGC_ANT_PM_ACI_POWER                            (PHY_AGC_ANT_BASE_ADDRESS + 0x154)
#define	REG_PHY_AGC_ANT_PM_RF_OFFSET                            (PHY_AGC_ANT_BASE_ADDRESS + 0x158)
#define	REG_PHY_AGC_ANT_PM_FB_OFFSET                            (PHY_AGC_ANT_BASE_ADDRESS + 0x15C)
#define	REG_PHY_AGC_ANT_PM_BB_OFFSET                            (PHY_AGC_ANT_BASE_ADDRESS + 0x160)
#define	REG_PHY_AGC_ANT_PM_HB_OFFSET                            (PHY_AGC_ANT_BASE_ADDRESS + 0x164)
#define	REG_PHY_AGC_ANT_PM_IB_OFFSET                            (PHY_AGC_ANT_BASE_ADDRESS + 0x168)
#define	REG_PHY_AGC_ANT_PM_ACI_OFFSET                           (PHY_AGC_ANT_BASE_ADDRESS + 0x16C)
#define	REG_PHY_AGC_ANT_PM_SATURATION_REG                       (PHY_AGC_ANT_BASE_ADDRESS + 0x170)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_DELAY                       (PHY_AGC_ANT_BASE_ADDRESS + 0x174)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_SOURCES                     (PHY_AGC_ANT_BASE_ADDRESS + 0x178)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_MAX_POWER_LEVEL             (PHY_AGC_ANT_BASE_ADDRESS + 0x17C)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_MIN_POWER_LEVEL             (PHY_AGC_ANT_BASE_ADDRESS + 0x180)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_SIGNAL_MAX_LEVEL            (PHY_AGC_ANT_BASE_ADDRESS + 0x184)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_ENV_MIN_LEVEL               (PHY_AGC_ANT_BASE_ADDRESS + 0x188)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_SIGNAL_ENV_DIFF_VALUES      (PHY_AGC_ANT_BASE_ADDRESS + 0x18C)
#define	REG_PHY_AGC_ANT_PM_ACC_GAIN_GSP_TABLE_CONTROL           (PHY_AGC_ANT_BASE_ADDRESS + 0x190)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_0                       (PHY_AGC_ANT_BASE_ADDRESS + 0x194)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_1                       (PHY_AGC_ANT_BASE_ADDRESS + 0x198)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_2                       (PHY_AGC_ANT_BASE_ADDRESS + 0x19C)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_3                       (PHY_AGC_ANT_BASE_ADDRESS + 0x1A0)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_4                       (PHY_AGC_ANT_BASE_ADDRESS + 0x1A4)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_5                       (PHY_AGC_ANT_BASE_ADDRESS + 0x1A8)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_6                       (PHY_AGC_ANT_BASE_ADDRESS + 0x1AC)
#define	REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_7                       (PHY_AGC_ANT_BASE_ADDRESS + 0x1B0)
#define	REG_PHY_AGC_ANT_PM_SEL_S2D_RX_LUT                       (PHY_AGC_ANT_BASE_ADDRESS + 0x1B4)
#define	REG_PHY_AGC_ANT_PM_PGC1_GAIN_OFFSET                     (PHY_AGC_ANT_BASE_ADDRESS + 0x1B8)
#define	REG_PHY_AGC_ANT_PM_PGC1_GAIN_LIMITS                     (PHY_AGC_ANT_BASE_ADDRESS + 0x1BC)
#define	REG_PHY_AGC_ANT_PM_PGC1_GAIN_SHIFT                      (PHY_AGC_ANT_BASE_ADDRESS + 0x1C0)
#define	REG_PHY_AGC_ANT_PM_RX_FILTER_CONTROL                    (PHY_AGC_ANT_BASE_ADDRESS + 0x1C4)
#define	REG_PHY_AGC_ANT_PM_RF_SYSTEM_GAIN_OFFSET                (PHY_AGC_ANT_BASE_ADDRESS + 0x1C8)
#define	REG_PHY_AGC_ANT_PM_FB_SYSTEM_GAIN_OFFSET                (PHY_AGC_ANT_BASE_ADDRESS + 0x1CC)
#define	REG_PHY_AGC_ANT_PM_BB_SYSTEM_GAIN_OFFSET                (PHY_AGC_ANT_BASE_ADDRESS + 0x1D0)
#define	REG_PHY_AGC_ANT_PM_POST_BB_SYSTEM_GAIN_OFFSET           (PHY_AGC_ANT_BASE_ADDRESS + 0x1D4)
#define	REG_PHY_AGC_ANT_PM_HB_SYSTEM_GAIN_OFFSET                (PHY_AGC_ANT_BASE_ADDRESS + 0x1D8)
#define	REG_PHY_AGC_ANT_PM_IB_SYSTEM_GAIN_OFFSET                (PHY_AGC_ANT_BASE_ADDRESS + 0x1DC)
#define	REG_PHY_AGC_ANT_PM_ACI_SYSTEM_GAIN_OFFSET               (PHY_AGC_ANT_BASE_ADDRESS + 0x1E0)
#define	REG_PHY_AGC_ANT_PM_CCA_SYSTEM_GAIN_OFFSET               (PHY_AGC_ANT_BASE_ADDRESS + 0x1E4)
#define	REG_PHY_AGC_ANT_PM_DET_SYSTEM_GAIN_OFFSET               (PHY_AGC_ANT_BASE_ADDRESS + 0x1E8)
#define	REG_PHY_AGC_ANT_PM_BB_BOF_OFFSET                        (PHY_AGC_ANT_BASE_ADDRESS + 0x1EC)
#define	REG_PHY_AGC_ANT_PM_HB_BOF_OFFSET                        (PHY_AGC_ANT_BASE_ADDRESS + 0x1F0)
#define	REG_PHY_AGC_ANT_PM_IB_RSSI_BOF_OFFSET                   (PHY_AGC_ANT_BASE_ADDRESS + 0x1F4)
#define	REG_PHY_AGC_ANT_PM_IB_ACI_BOF_OFFSET                    (PHY_AGC_ANT_BASE_ADDRESS + 0x1F8)
#define	REG_PHY_AGC_ANT_PM_DET_BOF_OFFSET                       (PHY_AGC_ANT_BASE_ADDRESS + 0x1FC)
#define	REG_PHY_AGC_ANT_PM_BB_BOF_TARGET                        (PHY_AGC_ANT_BASE_ADDRESS + 0x200)
#define	REG_PHY_AGC_ANT_PM_HB_BOF_TARGET                        (PHY_AGC_ANT_BASE_ADDRESS + 0x204)
#define	REG_PHY_AGC_ANT_PM_IB_BOF_TARGET                        (PHY_AGC_ANT_BASE_ADDRESS + 0x208)
#define	REG_PHY_AGC_ANT_PM_DET_BOF_TARGET                       (PHY_AGC_ANT_BASE_ADDRESS + 0x20C)
#define	REG_PHY_AGC_ANT_PM_DIFI1_DB_GAIN                        (PHY_AGC_ANT_BASE_ADDRESS + 0x210)
#define	REG_PHY_AGC_ANT_PM_PRESET_LNA_PGC1                      (PHY_AGC_ANT_BASE_ADDRESS + 0x214)
#define	REG_PHY_AGC_ANT_PM_MAX_BB_DIGITAL_GAIN                  (PHY_AGC_ANT_BASE_ADDRESS + 0x218)
#define	REG_PHY_AGC_ANT_PM_STEP1_BB_DIGITAL_GAIN                (PHY_AGC_ANT_BASE_ADDRESS + 0x21C)
#define	REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_BB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x220)
#define	REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_BB_DIGITAL_GAIN     (PHY_AGC_ANT_BASE_ADDRESS + 0x224)
#define	REG_PHY_AGC_ANT_PM_MAX_HB_DIGITAL_GAIN                  (PHY_AGC_ANT_BASE_ADDRESS + 0x228)
#define	REG_PHY_AGC_ANT_PM_STEP1_HB_DIGITAL_GAIN                (PHY_AGC_ANT_BASE_ADDRESS + 0x22C)
#define	REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_HB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x230)
#define	REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_HB_DIGITAL_GAIN     (PHY_AGC_ANT_BASE_ADDRESS + 0x234)
#define	REG_PHY_AGC_ANT_PM_MAX_IB_DIGITAL_GAIN                  (PHY_AGC_ANT_BASE_ADDRESS + 0x238)
#define	REG_PHY_AGC_ANT_PM_STEP1_IB_DIGITAL_GAIN                (PHY_AGC_ANT_BASE_ADDRESS + 0x23C)
#define	REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_IB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x240)
#define	REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_IB_DIGITAL_GAIN     (PHY_AGC_ANT_BASE_ADDRESS + 0x244)
#define	REG_PHY_AGC_ANT_PM_MAX_DET_DIGITAL_GAIN                 (PHY_AGC_ANT_BASE_ADDRESS + 0x248)
#define	REG_PHY_AGC_ANT_PM_STEP1_DET_DIGITAL_GAIN               (PHY_AGC_ANT_BASE_ADDRESS + 0x24C)
#define	REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_DET_DIGITAL_GAIN       (PHY_AGC_ANT_BASE_ADDRESS + 0x250)
#define	REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_DET_DIGITAL_GAIN    (PHY_AGC_ANT_BASE_ADDRESS + 0x254)
#define	REG_PHY_AGC_ANT_ACC_RF_POWER                            (PHY_AGC_ANT_BASE_ADDRESS + 0x258)
#define	REG_PHY_AGC_ANT_ACC_FB_POWER                            (PHY_AGC_ANT_BASE_ADDRESS + 0x25C)
#define	REG_PHY_AGC_ANT_ACC_BB_POWER                            (PHY_AGC_ANT_BASE_ADDRESS + 0x260)
#define	REG_PHY_AGC_ANT_ACC_HB_POWER                            (PHY_AGC_ANT_BASE_ADDRESS + 0x264)
#define	REG_PHY_AGC_ANT_ACC_IB_POWER                            (PHY_AGC_ANT_BASE_ADDRESS + 0x268)
#define	REG_PHY_AGC_ANT_ACC_ACI_POWER                           (PHY_AGC_ANT_BASE_ADDRESS + 0x26C)
#define	REG_PHY_AGC_ANT_ACC_SIGNAL_POWER                        (PHY_AGC_ANT_BASE_ADDRESS + 0x270)
#define	REG_PHY_AGC_ANT_ACC_ENV_POWER                           (PHY_AGC_ANT_BASE_ADDRESS + 0x274)
#define	REG_PHY_AGC_ANT_ACC_STATUS                              (PHY_AGC_ANT_BASE_ADDRESS + 0x278)
#define	REG_PHY_AGC_ANT_ACC_RF_SYSTEM_GAIN                      (PHY_AGC_ANT_BASE_ADDRESS + 0x27C)
#define	REG_PHY_AGC_ANT_ACC_FB_SYSTEM_GAIN                      (PHY_AGC_ANT_BASE_ADDRESS + 0x280)
#define	REG_PHY_AGC_ANT_ACC_BB_SYSTEM_GAIN                      (PHY_AGC_ANT_BASE_ADDRESS + 0x284)
#define	REG_PHY_AGC_ANT_ACC_POST_BB_SYSTEM_GAIN                 (PHY_AGC_ANT_BASE_ADDRESS + 0x288)
#define	REG_PHY_AGC_ANT_ACC_HB_SYSTEM_GAIN                      (PHY_AGC_ANT_BASE_ADDRESS + 0x28C)
#define	REG_PHY_AGC_ANT_ACC_IB_SYSTEM_GAIN                      (PHY_AGC_ANT_BASE_ADDRESS + 0x290)
#define	REG_PHY_AGC_ANT_ACC_ACI_SYSTEM_GAIN                     (PHY_AGC_ANT_BASE_ADDRESS + 0x294)
#define	REG_PHY_AGC_ANT_ACC_CCA_SYSTEM_GAIN                     (PHY_AGC_ANT_BASE_ADDRESS + 0x298)
#define	REG_PHY_AGC_ANT_ACC_DET_SYSTEM_GAIN                     (PHY_AGC_ANT_BASE_ADDRESS + 0x29C)
#define	REG_PHY_AGC_ANT_ACC_BB_DIGITAL_GAIN                     (PHY_AGC_ANT_BASE_ADDRESS + 0x2A0)
#define	REG_PHY_AGC_ANT_ACC_HB_DIGITAL_GAIN                     (PHY_AGC_ANT_BASE_ADDRESS + 0x2A4)
#define	REG_PHY_AGC_ANT_ACC_IB_DIGITAL_GAIN                     (PHY_AGC_ANT_BASE_ADDRESS + 0x2A8)
#define	REG_PHY_AGC_ANT_ACC_DET_DIGITAL_GAIN                    (PHY_AGC_ANT_BASE_ADDRESS + 0x2AC)
#define	REG_PHY_AGC_ANT_ACC_BB_BOF                              (PHY_AGC_ANT_BASE_ADDRESS + 0x2B0)
#define	REG_PHY_AGC_ANT_ACC_BB_TOTAL_DIGITAL_GAIN               (PHY_AGC_ANT_BASE_ADDRESS + 0x2B4)
#define	REG_PHY_AGC_ANT_ACC_BB_DIGITAL_BOF                      (PHY_AGC_ANT_BASE_ADDRESS + 0x2B8)
#define	REG_PHY_AGC_ANT_ACC_HB_BOF                              (PHY_AGC_ANT_BASE_ADDRESS + 0x2BC)
#define	REG_PHY_AGC_ANT_ACC_HB_TOTAL_DIGITAL_GAIN               (PHY_AGC_ANT_BASE_ADDRESS + 0x2C0)
#define	REG_PHY_AGC_ANT_ACC_HB_DIGITAL_BOF                      (PHY_AGC_ANT_BASE_ADDRESS + 0x2C4)
#define	REG_PHY_AGC_ANT_ACC_IB_BOF                              (PHY_AGC_ANT_BASE_ADDRESS + 0x2C8)
#define	REG_PHY_AGC_ANT_ACC_IB_TOTAL_DIGITAL_GAIN               (PHY_AGC_ANT_BASE_ADDRESS + 0x2CC)
#define	REG_PHY_AGC_ANT_ACC_IB_DIGITAL_BOF                      (PHY_AGC_ANT_BASE_ADDRESS + 0x2D0)
#define	REG_PHY_AGC_ANT_ACC_DET_BOF                             (PHY_AGC_ANT_BASE_ADDRESS + 0x2D4)
#define	REG_PHY_AGC_ANT_ACC_DET_TOTAL_DIGITAL_GAIN              (PHY_AGC_ANT_BASE_ADDRESS + 0x2D8)
#define	REG_PHY_AGC_ANT_ACC_DET_DIGITAL_BOF                     (PHY_AGC_ANT_BASE_ADDRESS + 0x2DC)
#define	REG_PHY_AGC_ANT_ACC_DC_OFFSET_I                         (PHY_AGC_ANT_BASE_ADDRESS + 0x2E0)
#define	REG_PHY_AGC_ANT_ACC_DC_OFFSET_Q                         (PHY_AGC_ANT_BASE_ADDRESS + 0x2E4)
#define	REG_PHY_AGC_ANT_PM_AGC_RAMS_RM                          (PHY_AGC_ANT_BASE_ADDRESS + 0x2E8)
#define	REG_PHY_AGC_ANT_ACC_GAIN_VALUES                         (PHY_AGC_ANT_BASE_ADDRESS + 0x2EC)
#define	REG_PHY_AGC_ANT_PM_SHORT_HEADER                         (PHY_AGC_ANT_BASE_ADDRESS + 0x2F0)
#define	REG_PHY_AGC_ANT_PM_FCSI_ADDRESS                         (PHY_AGC_ANT_BASE_ADDRESS + 0x2F4)
#define	REG_PHY_AGC_ANT_ACC_FCSI_VALUES                         (PHY_AGC_ANT_BASE_ADDRESS + 0x2F8)
#define	REG_PHY_AGC_ANT_ACC_GAIN_ACC_CONTROL                    (PHY_AGC_ANT_BASE_ADDRESS + 0x2FC)
#define	REG_PHY_AGC_ANT_PM_IB_CODE_ACC_THR                      (PHY_AGC_ANT_BASE_ADDRESS + 0x300)
#define	REG_PHY_AGC_ANT_PM_BB_CODE_ACC_THR                      (PHY_AGC_ANT_BASE_ADDRESS + 0x304)
#define	REG_PHY_AGC_ANT_PM_LONGTERM_RELEASE_THR                 (PHY_AGC_ANT_BASE_ADDRESS + 0x308)
#define	REG_PHY_AGC_ANT_PM_LONGTERM_THR                         (PHY_AGC_ANT_BASE_ADDRESS + 0x30C)
#define	REG_PHY_AGC_ANT_PM_BB_POWER_FAST_LOW_THR                (PHY_AGC_ANT_BASE_ADDRESS + 0x310)
#define	REG_PHY_AGC_ANT_PM_DELTA_CODE_ACC_THR                   (PHY_AGC_ANT_BASE_ADDRESS + 0x314)
#define	REG_PHY_AGC_ANT_PM_BB_POWER_UP_THR                      (PHY_AGC_ANT_BASE_ADDRESS + 0x318)
#define	REG_PHY_AGC_ANT_PM_BB_POWER_SLOW_LOW_THR                (PHY_AGC_ANT_BASE_ADDRESS + 0x31C)
#define	REG_PHY_AGC_ANT_PM_IB_POWER_UP_THR                      (PHY_AGC_ANT_BASE_ADDRESS + 0x320)
#define	REG_PHY_AGC_ANT_PM_IB_POWER_SLOW_LOW_THR                (PHY_AGC_ANT_BASE_ADDRESS + 0x324)
#define	REG_PHY_AGC_ANT_PM_SET_CODE_ACC_THR_CTRL                (PHY_AGC_ANT_BASE_ADDRESS + 0x328)
#define	REG_PHY_AGC_ANT_PM_ALGO_CTRL                            (PHY_AGC_ANT_BASE_ADDRESS + 0x32C)
#define	REG_PHY_AGC_ANT_ACC_EVENT_STATUS                        (PHY_AGC_ANT_BASE_ADDRESS + 0x330)
#define	REG_PHY_AGC_ANT_PM_BB_TH_SET_INC_GAP_DB                 (PHY_AGC_ANT_BASE_ADDRESS + 0x334)
#define	REG_PHY_AGC_ANT_PM_BB_TH_SET_DEC_GAP_DB                 (PHY_AGC_ANT_BASE_ADDRESS + 0x338)
#define	REG_PHY_AGC_ANT_PM_BB_TH_UP_EXTRA_GAP_DB                (PHY_AGC_ANT_BASE_ADDRESS + 0x33C)
#define	REG_PHY_AGC_ANT_PM_BB_POWER_UP_DEF_THR                  (PHY_AGC_ANT_BASE_ADDRESS + 0x340)
#define	REG_PHY_AGC_ANT_PM_BB_POWER_SLOW_LOW_MIN_THR            (PHY_AGC_ANT_BASE_ADDRESS + 0x344)
#define	REG_PHY_AGC_ANT_PM_IB_TH_SET_INC_GAP_DB                 (PHY_AGC_ANT_BASE_ADDRESS + 0x348)
#define	REG_PHY_AGC_ANT_PM_IB_TH_SET_DEC_GAP_DB                 (PHY_AGC_ANT_BASE_ADDRESS + 0x34C)
#define	REG_PHY_AGC_ANT_PM_IB_TH_UP_EXTRA_GAP_DB                (PHY_AGC_ANT_BASE_ADDRESS + 0x350)
#define	REG_PHY_AGC_ANT_PM_IB_POWER_UP_DEF_THR                  (PHY_AGC_ANT_BASE_ADDRESS + 0x354)
#define	REG_PHY_AGC_ANT_PM_IB_POWER_SLOW_LOW_MIN_THR            (PHY_AGC_ANT_BASE_ADDRESS + 0x358)
#define	REG_PHY_AGC_ANT_ACC_BB_POWER_UP_THR                     (PHY_AGC_ANT_BASE_ADDRESS + 0x35C)
#define	REG_PHY_AGC_ANT_ACC_BB_POWER_SLOW_LOW_THR               (PHY_AGC_ANT_BASE_ADDRESS + 0x360)
#define	REG_PHY_AGC_ANT_ACC_IB_POWER_UP_THR                     (PHY_AGC_ANT_BASE_ADDRESS + 0x364)
#define	REG_PHY_AGC_ANT_ACC_IB_POWER_SLOW_LOW_THR               (PHY_AGC_ANT_BASE_ADDRESS + 0x368)
#define	REG_PHY_AGC_ANT_CALC_AGC_GAIN_WORD                      (PHY_AGC_ANT_BASE_ADDRESS + 0x36C)
#define	REG_PHY_AGC_ANT_CALC_AGC_STM_CLEAR_CONTROL              (PHY_AGC_ANT_BASE_ADDRESS + 0x370)
#define	REG_PHY_AGC_ANT_CALC_ACC_AUTO_CLOSE_MODE                (PHY_AGC_ANT_BASE_ADDRESS + 0x374)
#define	REG_PHY_AGC_ANT_CALC_POWER_THR_ACC_GO                   (PHY_AGC_ANT_BASE_ADDRESS + 0x378)
#define	REG_PHY_AGC_ANT_CALC_AGC_GAIN_CANCEL                    (PHY_AGC_ANT_BASE_ADDRESS + 0x37C)
#define	REG_PHY_AGC_ANT_DISABLE_PERIPHERALS                     (PHY_AGC_ANT_BASE_ADDRESS + 0x380)
#define	REG_PHY_AGC_ANT_AGC_STM_RDBACK                          (PHY_AGC_ANT_BASE_ADDRESS + 0x384)
#define	REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_BB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x388)
#define	REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_BB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x38C)
#define	REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_HB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x390)
#define	REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_HB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x394)
#define	REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_IB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x398)
#define	REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_IB_DIGITAL_GAIN        (PHY_AGC_ANT_BASE_ADDRESS + 0x39C)
#define	REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_DET_DIGITAL_GAIN       (PHY_AGC_ANT_BASE_ADDRESS + 0x3A0)
#define	REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_DET_DIGITAL_GAIN       (PHY_AGC_ANT_BASE_ADDRESS + 0x3A4)
#define	REG_PHY_AGC_ANT_PM_BS_ABS_TH_B0_B4                      (PHY_AGC_ANT_BASE_ADDRESS + 0x3A8)
#define	REG_PHY_AGC_ANT_PM_BS_ABS_TH_B5_B7                      (PHY_AGC_ANT_BASE_ADDRESS + 0x3AC)
#define	REG_PHY_AGC_ANT_PM_BS_OFF_TH_B0_B4                      (PHY_AGC_ANT_BASE_ADDRESS + 0x3B0)
#define	REG_PHY_AGC_ANT_PM_BS_OFF_TH_B5_B7                      (PHY_AGC_ANT_BASE_ADDRESS + 0x3B4)
#define	REG_PHY_AGC_ANT_ACC_BLOCKER_MAP                         (PHY_AGC_ANT_BASE_ADDRESS + 0x3B8)
#define	REG_PHY_AGC_ANT_ACC_MAX_BLOCKER_POWER                   (PHY_AGC_ANT_BASE_ADDRESS + 0x3BC)
#define	REG_PHY_AGC_ANT_BLOCKER_CONTROL                         (PHY_AGC_ANT_BASE_ADDRESS + 0x3C0)
#define	REG_PHY_AGC_ANT_PM_BLOCKER_TH                           (PHY_AGC_ANT_BASE_ADDRESS + 0x3C4)
#define	REG_PHY_AGC_ANT_ACC_OFFSET_BS0_B4                       (PHY_AGC_ANT_BASE_ADDRESS + 0x3C8)
#define	REG_PHY_AGC_ANT_ACC_OFFSET_BS4_B7                       (PHY_AGC_ANT_BASE_ADDRESS + 0x3CC)
#define	REG_PHY_AGC_ANT_PM_ALGO_CTRL_SEL                        (PHY_AGC_ANT_BASE_ADDRESS + 0x3D0)
#define	REG_PHY_AGC_ANT_ACC_BLOCKER_ADDR                        (PHY_AGC_ANT_BASE_ADDRESS + 0x3D4)
/*---------------------------------------------------------------------------------
/						Data Type Definition										
/----------------------------------------------------------------------------------*/
/*REG_PHY_AGC_ANT_BB_RSSI_PARAMS_REG 0x0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbRssiParamsReg_u;

/*REG_PHY_AGC_ANT_BB_RSSI_OFFSET2_REG 0x4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbRssiOffset2Reg_u;

/*REG_PHY_AGC_ANT_BB_RSSI_SYSTEM_GAIN_REG 0x8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbRssiSystemGainReg_u;

/*REG_PHY_AGC_ANT_BB_RSSI_SYSTEM_GAIN_SELECT_REG 0xC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbRssiSystemGainSelectReg_u;

/*REG_PHY_AGC_ANT_BB_RSSI_SAT_THR 0x10 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbRssiSatThr_u;

/*REG_PHY_AGC_ANT_INB_RSSI_PARAMS_REG 0x14 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntInbRssiParamsReg_u;

/*REG_PHY_AGC_ANT_INB_RSSI_OFFSET2_REG 0x18 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntInbRssiOffset2Reg_u;

/*REG_PHY_AGC_ANT_INBAND_RSSI_SYSTEM_GAIN_REG 0x1C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntInbandRssiSystemGainReg_u;

/*REG_PHY_AGC_ANT_INBAND_RSSI_SYSTEM_GAIN_SELECT_REG 0x20 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntInbandRssiSystemGainSelectReg_u;

/*REG_PHY_AGC_ANT_INBAND_RSSI_SAT_THR 0x24 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntInbandRssiSatThr_u;

/*REG_PHY_AGC_ANT_FB_RSSI_PARAMS_REG 0x28 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbRssiParamsReg_u;

/*REG_PHY_AGC_ANT_FB_RSSI_OFFSET2_REG 0x2C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbRssiOffset2Reg_u;

/*REG_PHY_AGC_ANT_FB_RSSI_SYSTEM_GAIN_REG 0x30 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbRssiSystemGainReg_u;

/*REG_PHY_AGC_ANT_FB_RSSI_SYSTEM_GAIN_SELECT_REG 0x34 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbRssiSystemGainSelectReg_u;

/*REG_PHY_AGC_ANT_FB_RSSI_SAT_THR 0x38 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbRssiSatThr_u;

/*REG_PHY_AGC_ANT_HB_RSSI_PARAMS_REG 0x3C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbRssiParamsReg_u;

/*REG_PHY_AGC_ANT_HB_RSSI_OFFSET2_REG 0x40 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbRssiOffset2Reg_u;

/*REG_PHY_AGC_ANT_HB_RSSI_SYSTEM_GAIN_REG 0x44 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbRssiSystemGainReg_u;

/*REG_PHY_AGC_ANT_HB_RSSI_SYSTEM_GAIN_SELECT_REG 0x48 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbRssiSystemGainSelectReg_u;

/*REG_PHY_AGC_ANT_HB_RSSI_SAT_THR 0x4C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbRssiSatThr_u;

/*REG_PHY_AGC_ANT_RF_RSSI_PARAMS_REG 0x50 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiParamsReg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_OFFSET1_RX_RANGE0 0x54 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiOffset1RxRange0_u;

/*REG_PHY_AGC_ANT_RF_RSSI_OFFSET1_RX_RANGE1 0x58 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiOffset1RxRange1_u;

/*REG_PHY_AGC_ANT_RF_RSSI_OFFSET1_TX 0x5C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiOffset1Tx_u;

/*REG_PHY_AGC_ANT_RF_RSSI_OFFSET2_RX_REG 0x60 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiOffset2RxReg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_OFFSET2_TX_REG 0x64 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiOffset2TxReg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_SYSTEM_GAIN_REG 0x68 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiSystemGainReg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_SYSTEM_GAIN_SELECT_REG 0x6C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiSystemGainSelectReg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_SAT_THR_RANGE0 0x70 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiSatThrRange0_u;

/*REG_PHY_AGC_ANT_RF_RSSI_SAT_THR_RANGE1 0x74 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiSatThrRange1_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_A_RANGE0_REG 0x78 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefARange0Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_A_RANGE1_REG 0x7C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefARange1Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_A2_RANGE0_REG 0x80 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefA2Range0Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_A2_RANGE1_REG 0x84 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefA2Range1Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_B_RANGE0_REG 0x88 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefBRange0Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_B_RANGE1_REG 0x8C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefBRange1Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_C_RANGE0_REG 0x90 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefCRange0Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_C_RANGE1_REG 0x94 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefCRange1Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_NLOG_RANGE0_REG 0x98 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefNlogRange0Reg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_COEF_NLOG_RANGE1_REG 0x9C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiCoefNlogRange1Reg_u;

/*REG_PHY_AGC_ANT_RF_TSSI_COEF_A_REG 0xA0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfTssiCoefAReg_u;

/*REG_PHY_AGC_ANT_RF_TSSI_COEF_A2_REG 0xA4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfTssiCoefA2Reg_u;

/*REG_PHY_AGC_ANT_RF_TSSI_COEF_B_REG 0xA8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfTssiCoefBReg_u;

/*REG_PHY_AGC_ANT_RF_TSSI_COEF_C_REG 0xAC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfTssiCoefCReg_u;

/*REG_PHY_AGC_ANT_RF_TSSI_COEF_NLOG_REG 0xB0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfTssiCoefNlogReg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_TX_RX_REG 0xB4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiTxRxReg_u;

/*REG_PHY_AGC_ANT_BB_RSSI_REG 0xB8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbRssiReg_u;

/*REG_PHY_AGC_ANT_BB_POWER_REG 0xBC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbPowerReg_u;

/*REG_PHY_AGC_ANT_BB_SRSSI_REG 0xC0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbSrssiReg_u;

/*REG_PHY_AGC_ANT_BB_SPOWER_REG 0xC4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbSpowerReg_u;

/*REG_PHY_AGC_ANT_BB_PWR_DIFF_REG 0xC8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBbPwrDiffReg_u;

/*REG_PHY_AGC_ANT_IB_RSSI_REG 0xCC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntIbRssiReg_u;

/*REG_PHY_AGC_ANT_IB_POWER_REG 0xD0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntIbPowerReg_u;

/*REG_PHY_AGC_ANT_IB_SRSSI_REG 0xD4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntIbSrssiReg_u;

/*REG_PHY_AGC_ANT_IB_SPOWER_REG 0xD8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntIbSpowerReg_u;

/*REG_PHY_AGC_ANT_IB_PWR_DIFF_REG 0xDC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntIbPwrDiffReg_u;

/*REG_PHY_AGC_ANT_FB_RSSI_REG 0xE0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbRssiReg_u;

/*REG_PHY_AGC_ANT_FB_POWER_REG 0xE4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbPowerReg_u;

/*REG_PHY_AGC_ANT_FB_SRSSI_REG 0xE8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbSrssiReg_u;

/*REG_PHY_AGC_ANT_FB_SPOWER_REG 0xEC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbSpowerReg_u;

/*REG_PHY_AGC_ANT_FB_PWR_DIFF_REG 0xF0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntFbPwrDiffReg_u;

/*REG_PHY_AGC_ANT_HB_RSSI_REG 0xF4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbRssiReg_u;

/*REG_PHY_AGC_ANT_HB_POWER_REG 0xF8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbPowerReg_u;

/*REG_PHY_AGC_ANT_HB_SRSSI_REG 0xFC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbSrssiReg_u;

/*REG_PHY_AGC_ANT_HB_SPOWER_REG 0x100 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbSpowerReg_u;

/*REG_PHY_AGC_ANT_HB_PWR_DIFF_REG 0x104 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntHbPwrDiffReg_u;

/*REG_PHY_AGC_ANT_RF_RSSI_REG 0x108 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiReg_u;

/*REG_PHY_AGC_ANT_RF_POWER_REG 0x10C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfPowerReg_u;

/*REG_PHY_AGC_ANT_RF_SRSSI_REG 0x110 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfSrssiReg_u;

/*REG_PHY_AGC_ANT_RF_SPOWER_REG 0x114 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfSpowerReg_u;

/*REG_PHY_AGC_ANT_SATURATION_RESULT 0x118 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntSaturationResult_u;

/*REG_PHY_AGC_ANT_RSSI_BLOCKS_GCLK_EN 0x11C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRssiBlocksGclkEn_u;

/*REG_PHY_AGC_ANT_RF_RSSI_DEC_OUT_STS 0x120 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntRfRssiDecOutSts_u;

/*REG_PHY_AGC_ANT_PM_RF_POWER 0x140 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmRfPower_u;

/*REG_PHY_AGC_ANT_PM_FB_POWER 0x144 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmFbPower_u;

/*REG_PHY_AGC_ANT_PM_BB_POWER 0x148 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbPower_u;

/*REG_PHY_AGC_ANT_PM_HB_POWER 0x14C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmHbPower_u;

/*REG_PHY_AGC_ANT_PM_IB_POWER 0x150 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbPower_u;

/*REG_PHY_AGC_ANT_PM_ACI_POWER 0x154 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAciPower_u;

/*REG_PHY_AGC_ANT_PM_RF_OFFSET 0x158 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmRfOffset_u;

/*REG_PHY_AGC_ANT_PM_FB_OFFSET 0x15C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmFbOffset_u;

/*REG_PHY_AGC_ANT_PM_BB_OFFSET 0x160 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbOffset_u;

/*REG_PHY_AGC_ANT_PM_HB_OFFSET 0x164 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmHbOffset_u;

/*REG_PHY_AGC_ANT_PM_IB_OFFSET 0x168 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbOffset_u;

/*REG_PHY_AGC_ANT_PM_ACI_OFFSET 0x16C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAciOffset_u;

/*REG_PHY_AGC_ANT_PM_SATURATION_REG 0x170 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmSaturationReg_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_DELAY 0x174 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainDelay_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_SOURCES 0x178 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainSources_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_MAX_POWER_LEVEL 0x17C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainMaxPowerLevel_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_MIN_POWER_LEVEL 0x180 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainMinPowerLevel_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_SIGNAL_MAX_LEVEL 0x184 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainSignalMaxLevel_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_ENV_MIN_LEVEL 0x188 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainEnvMinLevel_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_SIGNAL_ENV_DIFF_VALUES 0x18C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainSignalEnvDiffValues_u;

/*REG_PHY_AGC_ANT_PM_ACC_GAIN_GSP_TABLE_CONTROL 0x190 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAccGainGspTableControl_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_0 0x194 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut0_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_1 0x198 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut1_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_2 0x19C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut2_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_3 0x1A0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut3_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_4 0x1A4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut4_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_5 0x1A8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut5_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_6 0x1AC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut6_u;

/*REG_PHY_AGC_ANT_PM_LNA_GAIN_LUT_7 0x1B0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLnaGainLut7_u;

/*REG_PHY_AGC_ANT_PM_SEL_S2D_RX_LUT 0x1B4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmSelS2DRxLut_u;

/*REG_PHY_AGC_ANT_PM_PGC1_GAIN_OFFSET 0x1B8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmPgc1GainOffset_u;

/*REG_PHY_AGC_ANT_PM_PGC1_GAIN_LIMITS 0x1BC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmPgc1GainLimits_u;

/*REG_PHY_AGC_ANT_PM_PGC1_GAIN_SHIFT 0x1C0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmPgc1GainShift_u;

/*REG_PHY_AGC_ANT_PM_RX_FILTER_CONTROL 0x1C4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmRxFilterControl_u;

/*REG_PHY_AGC_ANT_PM_RF_SYSTEM_GAIN_OFFSET 0x1C8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmRfSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_FB_SYSTEM_GAIN_OFFSET 0x1CC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmFbSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_BB_SYSTEM_GAIN_OFFSET 0x1D0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_POST_BB_SYSTEM_GAIN_OFFSET 0x1D4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmPostBbSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_HB_SYSTEM_GAIN_OFFSET 0x1D8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmHbSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_IB_SYSTEM_GAIN_OFFSET 0x1DC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_ACI_SYSTEM_GAIN_OFFSET 0x1E0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAciSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_CCA_SYSTEM_GAIN_OFFSET 0x1E4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmCcaSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_DET_SYSTEM_GAIN_OFFSET 0x1E8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmDetSystemGainOffset_u;

/*REG_PHY_AGC_ANT_PM_BB_BOF_OFFSET 0x1EC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbBofOffset_u;

/*REG_PHY_AGC_ANT_PM_HB_BOF_OFFSET 0x1F0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmHbBofOffset_u;

/*REG_PHY_AGC_ANT_PM_IB_RSSI_BOF_OFFSET 0x1F4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbRssiBofOffset_u;

/*REG_PHY_AGC_ANT_PM_IB_ACI_BOF_OFFSET 0x1F8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbAciBofOffset_u;

/*REG_PHY_AGC_ANT_PM_DET_BOF_OFFSET 0x1FC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmDetBofOffset_u;

/*REG_PHY_AGC_ANT_PM_BB_BOF_TARGET 0x200 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbBofTarget_u;

/*REG_PHY_AGC_ANT_PM_HB_BOF_TARGET 0x204 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmHbBofTarget_u;

/*REG_PHY_AGC_ANT_PM_IB_BOF_TARGET 0x208 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbBofTarget_u;

/*REG_PHY_AGC_ANT_PM_DET_BOF_TARGET 0x20C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmDetBofTarget_u;

/*REG_PHY_AGC_ANT_PM_DIFI1_DB_GAIN 0x210 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmDifi1DbGain_u;

/*REG_PHY_AGC_ANT_PM_PRESET_LNA_PGC1 0x214 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmPresetLnaPgc1_u;

/*REG_PHY_AGC_ANT_PM_MAX_BB_DIGITAL_GAIN 0x218 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxBbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_BB_DIGITAL_GAIN 0x21C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1BbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_BB_DIGITAL_GAIN 0x220 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1EnvSatBbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_BB_DIGITAL_GAIN 0x224 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1SignalSatBbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MAX_HB_DIGITAL_GAIN 0x228 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxHbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_HB_DIGITAL_GAIN 0x22C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1HbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_HB_DIGITAL_GAIN 0x230 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1EnvSatHbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_HB_DIGITAL_GAIN 0x234 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1SignalSatHbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MAX_IB_DIGITAL_GAIN 0x238 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxIbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_IB_DIGITAL_GAIN 0x23C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1IbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_IB_DIGITAL_GAIN 0x240 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1EnvSatIbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_IB_DIGITAL_GAIN 0x244 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1SignalSatIbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MAX_DET_DIGITAL_GAIN 0x248 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxDetDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_DET_DIGITAL_GAIN 0x24C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1DetDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_ENV_SAT_DET_DIGITAL_GAIN 0x250 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1EnvSatDetDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_STEP1_SIGNAL_SAT_DET_DIGITAL_GAIN 0x254 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmStep1SignalSatDetDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_RF_POWER 0x258 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccRfPower_u;

/*REG_PHY_AGC_ANT_ACC_FB_POWER 0x25C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccFbPower_u;

/*REG_PHY_AGC_ANT_ACC_BB_POWER 0x260 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbPower_u;

/*REG_PHY_AGC_ANT_ACC_HB_POWER 0x264 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccHbPower_u;

/*REG_PHY_AGC_ANT_ACC_IB_POWER 0x268 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbPower_u;

/*REG_PHY_AGC_ANT_ACC_ACI_POWER 0x26C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccAciPower_u;

/*REG_PHY_AGC_ANT_ACC_SIGNAL_POWER 0x270 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccSignalPower_u;

/*REG_PHY_AGC_ANT_ACC_ENV_POWER 0x274 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccEnvPower_u;

/*REG_PHY_AGC_ANT_ACC_STATUS 0x278 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccStatus_u;

/*REG_PHY_AGC_ANT_ACC_RF_SYSTEM_GAIN 0x27C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccRfSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_FB_SYSTEM_GAIN 0x280 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccFbSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_BB_SYSTEM_GAIN 0x284 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_POST_BB_SYSTEM_GAIN 0x288 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccPostBbSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_HB_SYSTEM_GAIN 0x28C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccHbSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_IB_SYSTEM_GAIN 0x290 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_ACI_SYSTEM_GAIN 0x294 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccAciSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_CCA_SYSTEM_GAIN 0x298 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccCcaSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_DET_SYSTEM_GAIN 0x29C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccDetSystemGain_u;

/*REG_PHY_AGC_ANT_ACC_BB_DIGITAL_GAIN 0x2A0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_HB_DIGITAL_GAIN 0x2A4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccHbDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_IB_DIGITAL_GAIN 0x2A8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_DET_DIGITAL_GAIN 0x2AC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccDetDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_BB_BOF 0x2B0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbBof_u;

/*REG_PHY_AGC_ANT_ACC_BB_TOTAL_DIGITAL_GAIN 0x2B4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbTotalDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_BB_DIGITAL_BOF 0x2B8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbDigitalBof_u;

/*REG_PHY_AGC_ANT_ACC_HB_BOF 0x2BC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccHbBof_u;

/*REG_PHY_AGC_ANT_ACC_HB_TOTAL_DIGITAL_GAIN 0x2C0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccHbTotalDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_HB_DIGITAL_BOF 0x2C4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccHbDigitalBof_u;

/*REG_PHY_AGC_ANT_ACC_IB_BOF 0x2C8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbBof_u;

/*REG_PHY_AGC_ANT_ACC_IB_TOTAL_DIGITAL_GAIN 0x2CC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbTotalDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_IB_DIGITAL_BOF 0x2D0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbDigitalBof_u;

/*REG_PHY_AGC_ANT_ACC_DET_BOF 0x2D4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccDetBof_u;

/*REG_PHY_AGC_ANT_ACC_DET_TOTAL_DIGITAL_GAIN 0x2D8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccDetTotalDigitalGain_u;

/*REG_PHY_AGC_ANT_ACC_DET_DIGITAL_BOF 0x2DC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccDetDigitalBof_u;

/*REG_PHY_AGC_ANT_ACC_DC_OFFSET_I 0x2E0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccDcOffsetI_u;

/*REG_PHY_AGC_ANT_ACC_DC_OFFSET_Q 0x2E4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccDcOffsetQ_u;

/*REG_PHY_AGC_ANT_PM_AGC_RAMS_RM 0x2E8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAgcRamsRm_u;

/*REG_PHY_AGC_ANT_ACC_GAIN_VALUES 0x2EC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccGainValues_u;

/*REG_PHY_AGC_ANT_PM_SHORT_HEADER 0x2F0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmShortHeader_u;

/*REG_PHY_AGC_ANT_PM_FCSI_ADDRESS 0x2F4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmFcsiAddress_u;

/*REG_PHY_AGC_ANT_ACC_FCSI_VALUES 0x2F8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccFcsiValues_u;

/*REG_PHY_AGC_ANT_ACC_GAIN_ACC_CONTROL 0x2FC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccGainAccControl_u;

/*REG_PHY_AGC_ANT_PM_IB_CODE_ACC_THR 0x300 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbCodeAccThr_u;

/*REG_PHY_AGC_ANT_PM_BB_CODE_ACC_THR 0x304 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbCodeAccThr_u;

/*REG_PHY_AGC_ANT_PM_LONGTERM_RELEASE_THR 0x308 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLongtermReleaseThr_u;

/*REG_PHY_AGC_ANT_PM_LONGTERM_THR 0x30C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmLongtermThr_u;

/*REG_PHY_AGC_ANT_PM_BB_POWER_FAST_LOW_THR 0x310 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbPowerFastLowThr_u;

/*REG_PHY_AGC_ANT_PM_DELTA_CODE_ACC_THR 0x314 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmDeltaCodeAccThr_u;

/*REG_PHY_AGC_ANT_PM_BB_POWER_UP_THR 0x318 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbPowerUpThr_u;

/*REG_PHY_AGC_ANT_PM_BB_POWER_SLOW_LOW_THR 0x31C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbPowerSlowLowThr_u;

/*REG_PHY_AGC_ANT_PM_IB_POWER_UP_THR 0x320 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbPowerUpThr_u;

/*REG_PHY_AGC_ANT_PM_IB_POWER_SLOW_LOW_THR 0x324 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbPowerSlowLowThr_u;

/*REG_PHY_AGC_ANT_PM_SET_CODE_ACC_THR_CTRL 0x328 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmSetCodeAccThrCtrl_u;

/*REG_PHY_AGC_ANT_PM_ALGO_CTRL 0x32C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAlgoCtrl_u;

/*REG_PHY_AGC_ANT_ACC_EVENT_STATUS 0x330 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccEventStatus_u;

/*REG_PHY_AGC_ANT_PM_BB_TH_SET_INC_GAP_DB 0x334 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbThSetIncGapDb_u;

/*REG_PHY_AGC_ANT_PM_BB_TH_SET_DEC_GAP_DB 0x338 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbThSetDecGapDb_u;

/*REG_PHY_AGC_ANT_PM_BB_TH_UP_EXTRA_GAP_DB 0x33C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbThUpExtraGapDb_u;

/*REG_PHY_AGC_ANT_PM_BB_POWER_UP_DEF_THR 0x340 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbPowerUpDefThr_u;

/*REG_PHY_AGC_ANT_PM_BB_POWER_SLOW_LOW_MIN_THR 0x344 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBbPowerSlowLowMinThr_u;

/*REG_PHY_AGC_ANT_PM_IB_TH_SET_INC_GAP_DB 0x348 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbThSetIncGapDb_u;

/*REG_PHY_AGC_ANT_PM_IB_TH_SET_DEC_GAP_DB 0x34C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbThSetDecGapDb_u;

/*REG_PHY_AGC_ANT_PM_IB_TH_UP_EXTRA_GAP_DB 0x350 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbThUpExtraGapDb_u;

/*REG_PHY_AGC_ANT_PM_IB_POWER_UP_DEF_THR 0x354 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbPowerUpDefThr_u;

/*REG_PHY_AGC_ANT_PM_IB_POWER_SLOW_LOW_MIN_THR 0x358 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmIbPowerSlowLowMinThr_u;

/*REG_PHY_AGC_ANT_ACC_BB_POWER_UP_THR 0x35C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbPowerUpThr_u;

/*REG_PHY_AGC_ANT_ACC_BB_POWER_SLOW_LOW_THR 0x360 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBbPowerSlowLowThr_u;

/*REG_PHY_AGC_ANT_ACC_IB_POWER_UP_THR 0x364 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbPowerUpThr_u;

/*REG_PHY_AGC_ANT_ACC_IB_POWER_SLOW_LOW_THR 0x368 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccIbPowerSlowLowThr_u;

/*REG_PHY_AGC_ANT_CALC_AGC_GAIN_WORD 0x36C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntCalcAgcGainWord_u;

/*REG_PHY_AGC_ANT_CALC_AGC_STM_CLEAR_CONTROL 0x370 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntCalcAgcStmClearControl_u;

/*REG_PHY_AGC_ANT_CALC_ACC_AUTO_CLOSE_MODE 0x374 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntCalcAccAutoCloseMode_u;

/*REG_PHY_AGC_ANT_CALC_POWER_THR_ACC_GO 0x378 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntCalcPowerThrAccGo_u;

/*REG_PHY_AGC_ANT_CALC_AGC_GAIN_CANCEL 0x37C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntCalcAgcGainCancel_u;

/*REG_PHY_AGC_ANT_DISABLE_PERIPHERALS 0x380 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntDisablePeripherals_u;

/*REG_PHY_AGC_ANT_AGC_STM_RDBACK 0x384 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAgcStmRdback_u;

/*REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_BB_DIGITAL_GAIN 0x388 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxLimitAccBbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_BB_DIGITAL_GAIN 0x38C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMinLimitAccBbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_HB_DIGITAL_GAIN 0x390 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxLimitAccHbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_HB_DIGITAL_GAIN 0x394 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMinLimitAccHbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_IB_DIGITAL_GAIN 0x398 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxLimitAccIbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_IB_DIGITAL_GAIN 0x39C */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMinLimitAccIbDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MAX_LIMIT_ACC_DET_DIGITAL_GAIN 0x3A0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMaxLimitAccDetDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_MIN_LIMIT_ACC_DET_DIGITAL_GAIN 0x3A4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmMinLimitAccDetDigitalGain_u;

/*REG_PHY_AGC_ANT_PM_BS_ABS_TH_B0_B4 0x3A8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBsAbsThB0B4_u;

/*REG_PHY_AGC_ANT_PM_BS_ABS_TH_B5_B7 0x3AC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBsAbsThB5B7_u;

/*REG_PHY_AGC_ANT_PM_BS_OFF_TH_B0_B4 0x3B0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBsOffThB0B4_u;

/*REG_PHY_AGC_ANT_PM_BS_OFF_TH_B5_B7 0x3B4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBsOffThB5B7_u;

/*REG_PHY_AGC_ANT_ACC_BLOCKER_MAP 0x3B8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBlockerMap_u;

/*REG_PHY_AGC_ANT_ACC_MAX_BLOCKER_POWER 0x3BC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccMaxBlockerPower_u;

/*REG_PHY_AGC_ANT_BLOCKER_CONTROL 0x3C0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntBlockerControl_u;

/*REG_PHY_AGC_ANT_PM_BLOCKER_TH 0x3C4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmBlockerTh_u;

/*REG_PHY_AGC_ANT_ACC_OFFSET_BS0_B4 0x3C8 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccOffsetBs0B4_u;

/*REG_PHY_AGC_ANT_ACC_OFFSET_BS4_B7 0x3CC */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccOffsetBs4B7_u;

/*REG_PHY_AGC_ANT_PM_ALGO_CTRL_SEL 0x3D0 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntPmAlgoCtrlSel_u;

/*REG_PHY_AGC_ANT_ACC_BLOCKER_ADDR 0x3D4 */
typedef union
{
	uint32 val;
	struct
...
} RegPhyAgcAntAccBlockerAddr_u;



#endif // _PHY_AGC_ANT_REGS_H_
