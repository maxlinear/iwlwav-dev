...
#define	REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_0                           (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22C0)
#define	REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_1                           (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22C4)
#define	REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_2                           (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22C8)
#define	REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_3                           (PHY_TX_MAC_EMU_BASE_ADDRESS + 0x22CC)
...
/*REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_0 0x22C0 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_1 0x22C4 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_2 0x22C8 */
typedef union
{
	uint32 val;
	struct
...
/*REG_PHY_TX_MAC_EMU_USER_FIRST_DATA_3 0x22CC */
typedef union
{
	uint32 val;
	struct
