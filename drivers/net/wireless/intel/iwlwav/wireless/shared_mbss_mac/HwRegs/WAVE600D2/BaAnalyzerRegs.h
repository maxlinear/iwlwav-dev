...
#define	REG_BA_ANALYZER_TXH_PSDU_LENGTH_THR                        (BA_ANALYZER_BASE_ADDRESS + 0x28)
...
/*REG_BA_ANALYZER_TXH_PSDU_LENGTH_THR 0x28 */
typedef union
{
	uint32 val;
	struct
	{
		uint32 crTxhPsduLengthThr : 30; //txh_psdu_length_thr, reset value: 0x200, access type: RW
		uint32 reserved0 : 2;
	} bitFields;
} RegBaAnalyzerTxhPsduLengthThr_u;
